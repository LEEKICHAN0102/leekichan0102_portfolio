      ...
      <Profile>
        ...
        <ModalTitle>술닥술닥</ModalTitle>
          ...
          <ModalSection>
            ...
            <p>술닥술닥은 술을 좋아하는 술 러버들을 위한 정보와 모임을 주도할 수 있는 커뮤니티 웹 사이트 입니다.</p>
            <p>제가 맡은 부분은 백오피스이며 웹에서 보여지게 될 여러가지 컨텐츠를 서버에 저장하고 유저와 관리자 계정을 관리하는 역할을 합니다.</p>
            <p>프로젝트 도중에 참여하여 기존의 코드를 파악한 후 작업하였으며 여러 Custom Hooks을 사용하여 코드 재사용을 용이하게 하고 리팩토링 하였습니다.</p>
          </ModalSection>
          <ModalDivider />
          <ModalSection>
            <ModalSubTitle>😀 What I've Learned ?</ModalSubTitle>
            <p>개인 프로젝트를 완료 한 이후 저에게 부족한 것이 무엇인지 생각해보니, <span>팀 프로젝트 경험</span>이 부족하다는 것이었습니다. </p>
            <p>첫 개인 프로젝트를 마무리 한 이후 팀 프로젝트에 참여한 적이 있습니다. 약 한달간의 기간을 잡고 시작 하였던 프로젝트 였으나, 프로젝트가 예상과는 다르게 장기화 되면서 시작 한지 두 달째 되던 즈음 유야무야 끝나버렸습니다.</p>
            <p>
              상황을 타개하려고 어떠한 행동도 취하지 않고 그저 흘러가듯 가만히 있던 본인 역시 문제 였습니다.
              소통이 안되서 불편한 점이 많았는데 <span>소통을 주도하려는 노력</span>을 적극적으로 하여야 했으나 팀 내에서 객관적으로
              실력이 가장 떨어졌던 제가 뭔가 건의하는 것이 <span>불쾌한 인상</span>을 남기지는 않을까? 혼자 위축 되어있었습니다.
            </p>
            <p>
              이후 팀 프로젝트 경험을 쌓기 위해 모집 공고들을 확인 하던 중 술닥술닥을 보게 되었고, 현업자 분들이 많이 계셨던 점과 주마다 <span>온라인 회의</span>, 달마다 <span>오프라인 정기회의</span>를 한다는 점에서 많은 것을 배울 수 있을 것 같다는 생각을 하였습니다.
              하여 위 작성 된 저의 구구절절한 사연을 가득 작성하여 많은 것을 배우고 싶다는 참여의사를 밝혔습니다.
            </p>
            <p>
              정말 감사하게도 관심을 가져주셔서 간단한 커피챗을 하며 몇 가지 기술 질문 이후 결과적으로 팀에 합류하게 되었습니다.
              현재는 술닥술닥의 <span>백오피스</span> 파트를 맏아 작업하고 있으며 팀원분들과 주기적인 회의와 소통으로 대학생분들의 개강 전인 8월 말 까지 프로젝트 완성을 위해 작업을 진행 중입니다. 😀
            </p>
          </ModalSection>
          <ModalDivider />
        </Modal>
      ...
      <Profile>
        ...
        <ModalTitle>PokéHub</ModalTitle>
          ...
          <ModalSection>
            ...
            <p>↪ AWS EC2로 배포한 BE 서버가 프르티어 기간이 끝나면서 비용문제로 중지하게 되면서 사용 할 수 있는 컨텐츠가 제한적이게 되었습니다. 불편하시겠지만 로컬에서 실행 해주시면 감사드리겠습니다. 😪
            </p>
            <ModalSubTitle>GitHub SourceCode</ModalSubTitle>
          ...
          <ModalSection>
            ...
            <p>도감이라는 컨셉에 맞지 않게 확인할 수 있는 컨텐츠가 제약적인 것, 실제 유저가 CRUD를 할 수 있는 환경이 아니라는 점, 좋지 않은 사용경험을 남길 수 있는 것등의 여러가지 아쉬운 점이 있었습니다.</p>
